...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'blog_event', 'end_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Event.end_date'
        db.alter_column(u'blog_event', 'end_date', self.gf('django.db.models.fields.DateField')())
